  ...
  return (
    <section style={{
      ...
      <div className="hero-content" style={{
        ...
        {/* Centered block — grows to fill available space, centers content vertically */}
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingTop: 128 }}>
        ...
        {/* Co-organized by — fixed gap below stat strip, fixed gap above boundary scale */}
